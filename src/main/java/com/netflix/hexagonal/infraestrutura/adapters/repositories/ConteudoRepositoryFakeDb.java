...
public class ConteudoRepositoryFakeDb implements ConteudoRepositoryPort {
    ...
    public ConteudoRepositoryFakeDb() {
        ...
        Conteudo conteudo2 = new Conteudo(Long.valueOf(2L), "Tipo2", "Titulo2",
                ...
                Arrays.asList("Listado 2.1", "Listado 2.2", "Listado 2.3"), "Descricao 2", null);
        ...
        Conteudo conteudo3 = new Conteudo(Long.valueOf(3L), "Tipo3", "Titulo3",
                ...
                Arrays.asList("Listado 3.1", "Listado 3.2", "Listado 3.3"), "Descricao 3", null);
    ...
    @Override
    public Page<Conteudo> buscarPorTituloPaginado(String titulo, int page, int size) {
        Pageable pageable = PageRequest.of(page, size, Sort.by("titulo").ascending());

        List<Conteudo> conteudos = buscarTodos().stream()
                .filter(c -> (c.getTitulo().contains(titulo) || titulo.isEmpty()))
                .collect(Collectors.toList());

        return new PageImpl<Conteudo>(conteudos);
    }
